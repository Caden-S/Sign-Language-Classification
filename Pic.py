...
for letter in alphabet:
  IMAGE_FILES = []
  for filename in glob.iglob("~training files dir~".format(letter) + '*.png', recursive=True):
    IMAGE_FILES.append(filename)
  for filename in glob.iglob("~training files dir~".format(letter) + '*.jpg', recursive=True):
    IMAGE_FILES.append(filename)
  with mp_hands.Hands(
